...
import { Avatar, Box, Card, CardContent, Fade, Grid, ToggleButton, ToggleButtonGroup, Typography } from "@mui/material"
            ...
            USD: {
                ...
                overview: {
                    monthly: {
                        ...
                        currentMonth: { income: 4509, payments: 1200, forecastedPayments: 7533 },
                    },
                    chart: {
                                                ...
                                                <Grid item xs={12} md={8}>
                                                    <Box height={200}>
                                                        <LineChart
                                                            ...
                                                            yAxis={[{ min: 0 }]} // Add this line to start Y-axis at 0
                                                            series={[
                                                                {
