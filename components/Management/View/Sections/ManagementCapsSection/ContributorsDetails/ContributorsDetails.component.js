...
const ContributorsDetails = ({ contributors = [], contributorsData = [] }) => {
  ...
  return (
    <Box
      ...
      className="contributors-details"
    >
      <Box mb={3} className="contributors-details-header">
        ...
        <Typography
          ...
          className="contributors-details-description"
        >
      ...
      <TableContainer
        component={Paper}
        className="contributors-table-container"
      >
        <Table sx={{ minWidth: 800 }} className="contributors-table">
          <TableHead className="contributors-table-head">
            <TableRow>
              <TableCell className="contributors-table-cell-head">
                {t(
                  'management.view.stats.team.contributors.table.heading.contributor'
                )}
              </TableCell>
              <TableCell
                align="center"
                className="contributors-table-cell-head"
              >
                <Box
                  display="flex"
                  alignItems="center"
                ...
                >
                  ...
                  {t(
                    'management.view.stats.team.contributors.table.heading.totaltasks'
                  )}
                </Box>
              </TableCell>
              <TableCell
              ...
              >
                ...
                >
                  ...
                  {t(
                    'management.view.stats.team.contributors.table.heading.investedeffort'
                  )}
                </Box>
              </TableCell>
              <TableCell
              ...
              >
                ...
                >
                  ...
                  {t(
                    'management.view.stats.team.contributors.table.heading.taskscompleted'
                  )}
                </Box>
              </TableCell>
              <TableCell
              ...
              >
                {t(
                  'management.view.stats.team.contributors.table.heading.recentactivity'
                )}
              </TableCell>
              <TableCell
                align="center"
              ...
              >
                {t(
                  'management.view.stats.team.contributors.table.heading.progress'
                )}
              </TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {contributors
              .map((c) => ({
                ...c,
                data: contributorsData.find((cd) => cd.id === c.contributorId),
              }))
              .map((contributor, index) => {
                ...
                const thumbnailUrl =
                  contributor.data?.profileMedia?.thumbnailUrl
                return (
                  <TableRow
                    key={contributor.contributorId}
                    className="contributors-table-row"
                  >
                    ...
                    <TableCell
                      align="center"
                      className="contributors-table-cell"
                    >
                      <Chip
