                            ...
                            {session ? (
                                <>
                                    ...
                                    >
                                        ...
                                        >
                                            <MenuItem onClick={handleCloseUserMenu}>{t("navbar.dashboard")}</MenuItem>
                                        </Link>
                                ...
                                {session ? (
                                    [
                                        <Link
                                            ...
                                            style={{ textDecoration: "none", color: "inherit" }}
                                        >
                                            <MenuItem onClick={handleCloseNavMenu}>{t("navbar.dashboard")}</MenuItem>
                                        </Link>,
                                    ...
                                    <MenuItem onClick={() => signIn("angorasixspring")}>{t("navbar.login")}</MenuItem>
                                )}
                            </Menu>
                        </Box>
                    )}
...
export default VisionaryNavbar
