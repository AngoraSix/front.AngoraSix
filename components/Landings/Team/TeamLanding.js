...
const TeamLanding = ({ translationKey }) => {
  ...
  const solutions = [
    ...
    {
      title: t('solutions.methodology.title'),
      description: t('solutions.methodology.description'),
      icon: <Route sx={{ fontSize: 40, color: 'white' }} />,
  ...
  const useCases = [
    ...
    {
      title: t('useCases.experiencedTeam.title'),
      description: t('useCases.experiencedTeam.description'),
    ...
    for (let i = 0; i < count; i++) {
      ...
      lines.push(
        ...
        >
          <animate
            attributeName="d"
            values={`M0,${yOffset} Q300,${
              yOffset - amplitude
            } 600,${yOffset} T1200,${yOffset};
                     M0,${yOffset + amplitude * Math.sin(phase)} Q300,${
              yOffset + amplitude * Math.sin(phase + frequency)
            } 600,${
              yOffset - amplitude * Math.sin(phase + frequency * 2)
            } T1200,${yOffset + amplitude * Math.sin(phase + frequency * 3)};
                     M0,${yOffset} Q300,${
              yOffset - amplitude
            } 600,${yOffset} T1200,${yOffset}`}
            dur={`${speed}s`}
    ...
    <>
      <Head>
        ...
        <meta
          property="og:url"
          key="og.url"
          content="https://angorasix.com/welcome/venture"
        />
      ...
      <Box className="team-landing-page">
        ...
        <Box
          id="how-it-works"
          data-animate
          className="team-how-it-works-section"
        >
          ...
          <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
            ...
            <Box>
              {howItWorksSteps.map((step, index) => (
                <Grow
                  in={visibleSections['how-it-works']}
                ...
                <Grid item xs={12} md={3} key={index}>
                  ...
                  >
                    ...
                    >
                      ...
                      <Typography
                        variant="body1"
                        className="solution-card-description"
                      >
                  ...
                  >
                    <Card className="use-case-card">
                      ...
                      <Box className="use-case-content">
                        ...
                        <Typography
                          variant="body2"
                          className="use-case-card-description"
                        >
                          {useCase.description}
                        </Typography>
                      </Box>
          ...
          <Container maxWidth="md">
            <Box className="final-cta-content">
              ...
              <Button
                ...
                className="final-cta-button cta-main"
              >
                {t('finalCta.cta')}
              </Button>
              <Button
                variant="outlined"
                size="large"
                onClick={navigateToKnowMore}
                className="final-cta-button cta-know-more"
              >
                {t('finalCta.ctaKnowMore')}
              </Button>
            </Box>
          </Container>
        </Box>
