...
const PricingComponent = () => {
  ...
  const initialSlide = 1 // start showing the Plus plan
              ...
              <Box className="beta-benefits">
                <Box className="beta-benefit">
                  ...
                  <Typography variant="body2">
                    {t('betaProgram.benefits.premium')}
                  </Typography>
                </Box>
                <Box className="beta-benefit">
                  <TrendingUp className="beta-benefit-icon" />
                  <Typography variant="body2">
                    {t('betaProgram.benefits.evolution')}
                  </Typography>
                </Box>
                <Box className="beta-benefit">
                  <Support className="beta-benefit-icon" />
                  <Typography variant="body2">
                    {t('betaProgram.benefits.priority')}
                  </Typography>
                </Box>
              </Box>
